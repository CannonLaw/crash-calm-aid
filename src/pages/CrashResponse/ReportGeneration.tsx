    ...
    try {
      ...
      setTimeout(() => {
        ...
        const body = encodeURIComponent(
          `Please find my car accident report generated by Cannon Law Crash Genius on ${currentDate} at ${currentTime}.\n\n` +
          `The report PDF has been downloaded to your device. Please attach the file "accident-report-${currentDate.replace(/\//g, '-')}.pdf" to this email.\n\n` +
          `Report Details:\n` +
          `- Date: ${currentDate}\n` +
          `- Time: ${currentTime}\n` +
          `- Location: ${collectedInfo?.accidentDetails?.location || 'Not specified'}\n\n` +
          `Generated using Crash Genius by Cannon Law\n` +
          `www.cannonlaw.com | (970) 471-7170`
        );
